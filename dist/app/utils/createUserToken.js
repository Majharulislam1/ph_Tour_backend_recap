...
exports.createNewAccessTokensR = exports.createUserTokens = void 0;
...
const createUserTokens = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(jwtPalyload, env_1.envVars.JWT_ACCESS_SECRET, env_1.envVars.JWT_ACCESS_EXPIRES);
    const refreshToken = (0, jwt_1.generateToken)(jwtPalyload, env_1.envVars.JWT_REFRESH_SECRET, env_1.envVars.JWT_REFRESH_EXPIRES);
    return {
        accessToken,
        refreshToken
    };
...
const createNewAccessTokensR = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const verifyRefreshToken = (0, jwt_1.verifyToken)(refreshToken, env_1.envVars.JWT_REFRESH_SECRET);
    const isUserExist = yield user_models_1.User.findOne({ email: verifyRefreshToken.email });
    if (!isUserExist) {
...
exports.createNewAccessTokensR = createNewAccessTokensR;
